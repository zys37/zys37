# Franek Siek ⌨
<p align="center">
  I am an Electronics Engineer (graduated from Wrocław University of Science and Technology), specializing in Signal Processing Systems.
My programming journey started with Python and C++, giving me a solid object-oriented foundation. Recently, my main focus has been on Software Development and AI. I have hands-on experience building web applications using JavaScript (React) as well as implementing machine learning algorithms (TensorFlow, Scikit-learn).
Video games remain a huge passion of mine. I developed my engineering thesis simulator in the Godot Engine, and in my free time, I create my own 2D pixel art assets using Aseprite. I've published some of my work on the Unity Asset Store and itch.io – feel free to check them out by clicking the icons below!
...
This project was all about  API testing using the power of AI. Our goal was to make API testing faster, easier, and less prone to errors by letting users describe test scenarios in natural language, then having AI generate the test steps, data, and even validate the API responses. 
As part of a four-person team, I was responsible for crafting the frontend of this system. I focused on building a lightweight and intuitive user interface using HTML and CSS. This simple, clean structure allowed for rapid testing and a smooth user experience. That was my first contact with html + CSS. It was a fantastic experience working with the guys on a real project for practical application. As for a first contact with frontend, I've really enjoyed that.
<!---
